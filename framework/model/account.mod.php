...
function uni_templates() {
	...
	$extend = pdo_getall('uni_account_group', array('uniacid' => $_W['uniacid']), array(), 'groupid');	$uni_extend = pdo_get('uni_group', array('uniacid' => $_W['uniacid']));		$template_default = pdo_fetchall("SELECT * FROM " . tablename('site_templates') . " WHERE name = 'default'", array(), 'id');
